...
(function() {
  module.exports = function(grunt) {
    ...
    grunt.registerTask('css-replace-url', function() {
      var cssContent, done, fs, newCssContent;
      done = this.async();
      fs = require('fs');
    ...
    grunt.registerTask('js-add-closures', function() {
      var done, fs, jsContent, newJsContent;
      done = this.async();
      fs = require('fs');
    ...
    return grunt.registerTask('default', ['copy:lib', 'coffee:compile']);
  };
