(function(){
    ...
    UM.registerWidget('emotion',{
        ...
        tpl: "<link type=\"text/css\" rel=\"stylesheet\" href=\"<%=emotion_url%>emotion.css\">" +
            ...
            "<images src=\"<%=cover_img%>\" class=\'edui-emotion-JfaceReview edui-emotion-preview-images\'/>" +
            "</div>",
        ...
        initContent:function( _editor, $widget ){
            ...
            emotion.SmileyPath = _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : "http://images.baidu.com/hi/";
            ...
            for ( ; i < imgNum; ) {
                ...
                for ( var j = 0; j < imgColNum; j++, i++ ) {
                    ...
                    if ( faceImage ) {
                        ...
                        textHTML.push( '<span>' );
                        textHTML.push( '<images  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : 'default/0.gif" width="') + iWidth + '" height="' + iHeight + '"></images>' );
                        textHTML.push( '</span>' );
                    } else {
